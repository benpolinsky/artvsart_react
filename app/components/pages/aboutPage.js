    ...
    return (
      ...
      <div style={baseStyles.contentPage}>
        ...
        <div style={pageStyles}>
          ...
          <p style={baseStyles.paragraph}>
            The site ranks art using the ELO algorithm, which takes into consideration the relative 
            strength of each competitor during a given matchup.  
          ...
          <p style={baseStyles.paragraph}>
            ...
            That's all you need to know for now.<br/>
          ...
          <p style={baseStyles.paragraph}>
            ...
            While it might be fun for you to see how your band's demo stacks up against the competition,
            that's a different animal, and I refuse to entertain the possibility.    
          </p>
          <p style={baseStyles.paragraph}>To suggest a piece of art to be added, or if you've got any other Art Vs Art inquiries, you can email <a href='mailto:artvsartcontact@gmail.com'>artvsartcontact@gmail.com</a>.</p>
