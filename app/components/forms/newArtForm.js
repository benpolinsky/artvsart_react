...
class NewArtForm extends React.Component{
  ...
  render(){
    const {submit, handleSubmit, errors} = this.props;
    return(
     <MuiThemeProvider>
      <form ref='form' onSubmit={handleSubmit(this.onSubmit)} className='createArtForm centered-form'>
